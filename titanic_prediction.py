...
def createModel():
    ...
    trainData["Embarked"] = embImp.transform(trainData[["Embarked"]]).flatten()  # Dönüşüm sonrası veriyi düzleştir
...
# Test
fitModel, embEnc, sexEnc, ageScaler = createModel()
values = {
    'Pclass': [1],
    'Sex': ['female'],
    'Age': [22],
...
print(predRes(fitModel, embEnc, sexEnc, ageScaler, values))